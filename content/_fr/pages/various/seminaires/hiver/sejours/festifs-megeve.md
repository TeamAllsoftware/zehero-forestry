                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion1" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                                ...
                                <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                    <div class="panel-body-no-marg-fullwidth">La station de Megève est située à une altitude de 1113 mètres</div>
                                </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                            ...
                            <div class="panel border-color-black-transparent">
                                <div class="panel-heading">
                                    ...
                                    <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion2">
                                        <div class="panel-body-no-marg-fullwidth">"Espace Diamant" 445 km de pistes de 1113 m. à 2350 m.</div>
                                    </div>
                                </div>
                            <!-- end accordion item -->
                        </div>
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      ...
                                      <li><i class="fas fa-check mb-0"></i>15h : initiation patinage sur glace (en option)</li>
                                      <li><i class="fas fa-check mb-0"></i>17h : accès libre au Spa de l'hôtel</li>
                                      <li><i class="fas fa-check mb-0"></i>19h : dîner à Megève</li>
                                    </ul>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      <li><i class="fas fa-check mb-0"></i>8h : petit déjeuner</li>
                                      <li><i class="fas fa-check mb-0"></i>10h : accès au massif de Rochebrune par télécabine</li>
                                      <li><i class="fas fa-check mb-0"></i>12h30 : déjeuner en chalet d'altitude à 1 895 m. au départ de la célèbre piste Emile ALLAIS</li>
                    ...
                    <div class="tab-pane fade in" id="tab-nine4">
                        <div class="panel-group accordion-event accordion-style-04" id="accordion4" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                  <div class="panel-body-no-marg-fullwidth">L'après ski, les boutiques et le charme du village</div>
                              </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion6" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      <li><i class="fas fa-check mb-0"></i>TGV Sallanches (4h30)</li>
                                      <li><i class="fas fa-check mb-0"></i>navette (15 km)</li>
                                    </ul>
                                  </div>
                              </div>
                            </div>
