                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion1" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                                ...
                                <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                    <div class="panel-body-no-marg-fullwidth">La station de Val-Thorens est située à une altitude de 2300 mètres</div>
                                </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      ...
                                      <li><i class="fas fa-check mb-0"></i>13h : déjeuner en chalet d'altitude à 3000 m.</li>
                                      <li><i class="fas fa-check mb-0"></i>14h : 2 descentes du Tobogan (en option)</li>
                                      <li><i class="fas fa-check mb-0"></i>17h : retour à l'hôtel</li>
                                      <li><i class="fas fa-check mb-0"></i>19h : dîner en chalet d'altitude sur les pistes</li>
                                    </ul>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      <li><i class="fas fa-check mb-0"></i>8h : petit déjeuner</li>
                                      <li><i class="fas fa-check mb-0"></i>9h : montée à la Cîme de Caron à 3200 m. par le téléphérique et photo de groupe (en option)</li>
                    ...
                    <div class="tab-pane fade in" id="tab-nine4">
                        <div class="panel-group accordion-event accordion-style-04" id="accordion4" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                  <div class="panel-body-no-marg-fullwidth">L'enneigement garanti de novembre à mai !</div>
                              </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
