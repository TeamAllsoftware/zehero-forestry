                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion1" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                                ...
                                <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                    <div class="panel-body-no-marg-fullwidth">La station de Grand Revard est située à une altitude de 1250 mètres</div>
                                </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                                ...
                                <div>
                                    <div class="panel-body-marg-fullwidth">
                                      <ul class="list-style-01">
                                        <li><i class="fas fa-check mb-0"></i>Arrivée en fin d'après midi, installation dans la résidence</li>
                                        <li><i class="fas fa-check mb-0"></i>20h : dîner dans un restaurant à 200 m.</li>
                                      </ul>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      ...
                                      <li><i class="fas fa-check mb-0"></i>12h30 : déjeuner dans un restaurant de la station</li>
                                      <li><i class="fas fa-check mb-0"></i>14h : initiation au Ski-Joering (attelage porté par un cheval qui tire les skieurs sur une piste damée)</li>
                                      <li><i class="fas fa-check mb-0"></i>17h : retour à l'hôtel</li>
                                      <li><i class="fas fa-check mb-0"></i>19h : dîner et soirée dansante</li>
                                    </ul>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      <li><i class="fas fa-check mb-0"></i>8h : petit déjeuner</li>
                                      <li><i class="fas fa-check mb-0"></i>9h : randonnée en raquettes depuis le belvédère de l'Orionde à 1 522 m.</li>
                                      <li><i class="fas fa-check mb-0"></i>12h30 : déjeuner dans un chalet sur les pistes</li>
                    ...
                    <div class="tab-pane fade in" id="tab-nine4">
                        <div class="panel-group accordion-event accordion-style-04" id="accordion4" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                  <div class="panel-body-no-marg-fullwidth">L'accès ultra rapide et le cadre sur ce premier plateau des Bauges</div>
                              </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion6" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      <li><i class="fas fa-check mb-0"></i>TGV Chambéry (3h)</li>
