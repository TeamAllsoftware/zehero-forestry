                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion1" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                                ...
                                <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                    <div class="panel-body-no-marg-fullwidth">La station de Chamonix est située à une altitude de 1035 mètres</div>
                                </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                            ...
                            <div class="panel border-color-black-transparent">
                                <div class="panel-heading">
                                    ...
                                    <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion2">
                                        <div class="panel-body-no-marg-fullwidth">Vallée de Chamonix 470 km de pistes reliés par navettes (Les Houches, Brévent-Flégère, Les Grands Montets) entre 1035 m et 3275 m.</div>
                                    </div>
                                </div>
                            <!-- end accordion item -->
                        </div>
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      ...
                                      <li><i class="fas fa-check mb-0"></i>10h : Accès à la mer de glace par le chemin de fer à crémaillère et visite du musée de l'alpinisme</li>
                                      <li><i class="fas fa-check mb-0"></i>12h30 : déjeuner à l'hôtel du Montenvers datant du 19ème</li>
                                      <li><i class="fas fa-check mb-0"></i>16h : retour à l'hôtel</li>
                                      <li><i class="fas fa-check mb-0"></i>17h : retour à l'hôtel</li>
                                      <li><i class="fas fa-check mb-0"></i>19h : dîner dans le coeur historique de Chamonix</li>
                                    </ul>
                                  </div>
                              </div>
                            </div>
                    ...
                    <div class="tab-pane fade in" id="tab-nine4">
                        <div class="panel-group accordion-event accordion-style-04" id="accordion4" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                  <div class="panel-body-no-marg-fullwidth">La situation de l'hôtel en centre village à deux pas de l'aiguille du Midi et du train du Montenvers</div>
                              </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                    ...
                    <div class="tab-pane fade in" id="tab-nine5">
                        <div class="panel-group accordion-event accordion-style-04" id="accordion5" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div id="accordion-style-4-1" class="panel-collapse " data-bs-parent="#accordion1">
                                  <div class="panel-body-no-marg-fullwidth">Toute l'année</div>
                              </div>
                            </div>
                            <!-- end accordion item -->
                        </div>
                        ...
                        <div class="panel-group accordion-event accordion-style-04" id="accordion6" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                            ...
                            <div class="panel border-color-black-transparent">
                              ...
                              <div>
                                  <div class="panel-body-marg-fullwidth">
                                    <ul class="list-style-01">
                                      <li><i class="fas fa-check mb-0"></i>TGV Saint-Gervais-Les-Bains-Le-Flayet (4h45)</li>
